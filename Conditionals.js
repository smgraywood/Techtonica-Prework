...
// "The value of num1 is <value here> and is greater than 10".
  ...
  function exercise1(num1) {
    return (num1 >10 ? `The value of num1 is ${num1} and is greater than 10` : "num 1 is small")
...
function exercise2(num2) {
    let answer2 = num2 +"value is even";
  if (1 === num2 % 2) {
      answer2 = num2 +"value is odd"
  }
    return answer2;
  }
  
  //ternary operator method
  function exercise1(num2) {
    return (1 === num2 % 2 ? `${num2} the value is even` : `${num2} the value is odd`)
